...
$federationName = 'IDEM Federation';

// URL to send user to when clicking on federation logo
$federationURL = 'http://www.idem.garr.it/';
...
$metadataLockFile = '/tmp/statistics_metadata.lock';

// Where to log the access
// Make sure the web server user has write access to this file!
$WAYFLogFile = '/var/log/apache2/statistics.log'; 
