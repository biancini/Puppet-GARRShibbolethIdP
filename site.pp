  ...
  shib2idp::instance { "${hostname}-idp":
    metadata_information    => {
      'en'                => {
        ...
        'url_LogoOrg_32x32'      => 'https://puppetclient.mib.garr.it/idp/images/logoEnte-32x32_en.png',
        'url_LogoOrg_160x120'    => 'https://puppetclient.mib.garr.it/idp/images/logoEnte-160x120_en.png',
      },
      'it'                => {
        'orgDisplayName'         => 'Test IdP for IdP in the cloud project',
        'communityDesc'          => 'GARR Research&amp;Development',
        ...
        'nameOrg'                => 'Consortium GARR',
        'idpInfoUrl'             => 'https://puppetclient.mib.garr.it/idp/info.html',
        'url_LogoOrg_32x32'      => 'https://puppetclient.mib.garr.it/idp/images/logoEnte-32x32_it.png',
        'url_LogoOrg_160x120'    => 'https://puppetclient.mib.garr.it/idp/images/logoEnte-160x120_it.png',
      },
